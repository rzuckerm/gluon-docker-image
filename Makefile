GLUON_VERSION := $(shell cat GLUON_VERSION)
GLUON_DEPS := $(wildcard GLUON_*)
DOCKER_TAG_PREFIX := rzuckerm/gluon:$(GLUON_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(GLUON_DEPS)
